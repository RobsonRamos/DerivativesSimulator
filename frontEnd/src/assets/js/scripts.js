        ...
        if ($(placeholder).length) {
            ...
            $(".assign-task").on("click", function() {
                ...
                if (taskTitle == "") {
                    ...
                    var newTaskContent = '<li class="task-list-item" style="opacity:0;""><div class="checkbox" data-toggle="buttons"><label class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input"><span class="custom-control-indicator"></span><span class="custom-control-description">' + priorityBadge + optionalBadge + taskTitle + '</span></label></div><div class="task-item-details">' + taskDetails + '</div><div class="task-item-controls"><a role="button" class="btn btn-info btn-sm show-task" href="#"><span class="batch-icon batch-icon-arrow-down"></span></a></div><div class="task-item-users">' + taskUsersContent + '</div></li>';
        ...
        if (placeholder.length) {
            ...
            $("#send-email").on("click", function(e) {
                ...
                if (emailsMainObj == "") {
                    ...
                    $(".mailbox-controls").after(successMessage);
                    $(".mailbox-controls").next().fadeIn(300);
