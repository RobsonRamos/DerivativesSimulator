...
namespace API.Math
{
    public static class StandardNormalDistribution
    {
        ...
        public static double ProbabilityDensityFunction(double x)
        {
            ...
            return ONE_OVER_SQRT_2_PI * System.Math.Exp(-0.5 * x * x);
        }
        ...
        public static double Probability(double minValue, double maxValue)
        {
        ...
        /// </remarks>
        public static double DistributionFunction(double z)
        {
            ...
            {
                double Exponential = System.Math.Exp(-System.Math.Pow(XAbs, 2.0) / 2.0);
        ...
        /// <returns></returns>
        public static double SurvivorDistributionFunction(double z)
        {
        ...
        /// </remarks>
        public static double InverseDistributionFunction(double probability)
        {
